...
import {smartcontrol} from '../models';
...
export function GetAdaptiveStatus():Promise<smartcontrol.AdaptiveStatus>;
...
export function SetAdaptiveMode(arg1:boolean):Promise<smartcontrol.AdaptiveStatus>;

export function SetAdaptivePreference(arg1:number):Promise<smartcontrol.AdaptiveStatus>;

export function SetAdaptiveTempLimit(arg1:number):Promise<smartcontrol.AdaptiveStatus>;
